...
{
    public partial class AdminLogExport : System.Web.UI.Page
    {
        ...
        protected void ExportExcel(object sender, EventArgs e) {
            ...
            Response.AddHeader("content-disposition","attachment;filename=AuditLogExport.xls"); //file type
            Response.Charset = "";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                DataTable dt = ATO.GetLookupAdmin(); //Call controller to get all data in side auditLog DB 
