<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Custom_Error_Page.aspx.cs" Inherits="EAD_Project.Custom_Error_Page" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="float:left;">
            ...
            <ul style="list-style:none; padding-left:0;">
                ...
                <li><a style="color:#FF7377; font-size:20px; text-decoration:none; margin-top:-20px !important;" href="Login.aspx">Login</a></li>
            </ul>
